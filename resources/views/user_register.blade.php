...
<body>
    ...
    <div class="page-content">
        <div class="container">
          <h2 class="divider">Регистрация</h2>

          <form class="form" method="POST" action="/register/confirm" enctype="multipart/form-data">
            @csrf

            <div class="form-block">
                <input type="text" id="fullname" name="fullname" placeholder="Введите ФИО">
                {!! isset($errors_data['fullname']) ? '<span>' . $errors_data['fullname'] . '</span>' : '' !!}
            </div>

            <div class="form-block">
                <input type="email" id="email" name="email" placeholder="Введите почту">
                {!! isset($errors_data['email']) ? '<span>' . $errors_data['email'] . '</span>' : '' !!}
            </div>
            ...
            <div class="form-block">
                <p>Уже есть аккаунт? <a href="/login" class="page-swapper">Войти</a></p>
            </div>
